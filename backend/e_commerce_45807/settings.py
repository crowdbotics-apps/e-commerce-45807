"""
Django settings for e_commerce_45807 project.
...
ROOT_URLCONF = 'e_commerce_45807.urls'
...
WSGI_APPLICATION = 'e_commerce_45807.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "e_commerce_45807 API",
    "DESCRIPTION": "API documentation for e_commerce_45807 App",
    "VERSION": "v1",
}
